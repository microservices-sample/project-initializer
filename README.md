...
5) Based on your operating system either cd  mac or win folder and execute ./init.sh or init.cmd which pulls all the depedent git repositories</br>
6) To deploy docker please run "./deploy.sh docker" or "deploy.cmd docker".</br>
7) Access the Application at http://localhost/</br></br>
